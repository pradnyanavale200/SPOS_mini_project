...
_mkfile:     file format elf32-i386
   ...
   f:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  21:	e8 dc 02 00 00       	call   302 <open>
  26:	83 c4 10             	add    $0x10,%esp
  29:	85 c0                	test   %eax,%eax
  2b:	78 0e                	js     3b <main+0x3b>
  ...
  30:	50                   	push   %eax
  31:	e8 b4 02 00 00       	call   2ea <close>
  exit();
  36:	e8 87 02 00 00       	call   2c2 <exit>
     printf(1, "wc: cannot open %s\n", argv[1]);
  3b:	50                   	push   %eax
  3c:	ff 73 04             	pushl  0x4(%ebx)
  3f:	68 78 07 00 00       	push   $0x778
  44:	6a 01                	push   $0x1
  46:	e8 c5 03 00 00       	call   410 <printf>
     exit();
  4b:	e8 72 02 00 00       	call   2c2 <exit>
    printf(1, "need 1 argument");
  50:	51                   	push   %ecx
  51:	51                   	push   %ecx
  52:	68 68 07 00 00       	push   $0x768
  57:	6a 01                	push   $0x1
  59:	e8 b2 03 00 00       	call   410 <printf>
    exit();
  5e:	e8 5f 02 00 00       	call   2c2 <exit>
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
