  ...
  19:	83 f8 02             	cmp    $0x2,%eax
{
  ...
  if(argc <= 2){
  1f:	0f 8e ab 00 00 00    	jle    d0 <main+0xd0>
  25:	8b 7a 04             	mov    0x4(%edx),%edi
  int i=0, sum=0, j;
  ...
  while(argv[1][i] != '\0'){
  2c:	0f be 04 1f          	movsbl (%edi,%ebx,1),%eax
  30:	84 c0                	test   %al,%al
  32:	74 1a                	je     4e <main+0x4e>
    if(argv[1][i] < 48 || argv[1][i] > 57){
  34:	8d 48 d0             	lea    -0x30(%eax),%ecx
  37:	80 f9 09             	cmp    $0x9,%cl
  3a:	77 74                	ja     b0 <main+0xb0>
      printf(1,"enter number");
    }
    else{
      sum=sum*10+(argv[1][i]-48);
  3c:	8d 0c b6             	lea    (%esi,%esi,4),%ecx
      i++;
  3f:	83 c3 01             	add    $0x1,%ebx
      sum=sum*10+(argv[1][i]-48);
  42:	8d 74 48 d0          	lea    -0x30(%eax,%ecx,2),%esi
  while(argv[1][i] != '\0'){
  46:	0f be 04 1f          	movsbl (%edi,%ebx,1),%eax
  4a:	84 c0                	test   %al,%al
  4c:	75 e6                	jne    34 <main+0x34>
    }
  }

  for(i = 0; i < sum; i++){
  4e:	85 f6                	test   %esi,%esi
  50:	74 53                	je     a5 <main+0xa5>
  52:	8b 45 e0             	mov    -0x20(%ebp),%eax
  55:	31 ff                	xor    %edi,%edi
  57:	89 75 e0             	mov    %esi,-0x20(%ebp)
  5a:	8d 1c 82             	lea    (%edx,%eax,4),%ebx
  5d:	8d 42 08             	lea    0x8(%edx),%eax
  60:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  63:	90                   	nop
  64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  68:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  6b:	90                   	nop
  ...
  73:	ff 36                	pushl  (%esi)
  75:	83 c6 04             	add    $0x4,%esi
  78:	68 ff 07 00 00       	push   $0x7ff
  7d:	6a 01                	push   $0x1
  7f:	e8 0c 04 00 00       	call   490 <printf>
      for(j = 2; j < argc; j++){
  ...
  8e:	83 c7 01             	add    $0x1,%edi
      printf(1, "\n");
  91:	68 03 08 00 00       	push   $0x803
  96:	6a 01                	push   $0x1
  98:	e8 f3 03 00 00       	call   490 <printf>
  for(i = 0; i < sum; i++){
  9d:	83 c4 10             	add    $0x10,%esp
  a0:	39 7d e0             	cmp    %edi,-0x20(%ebp)
  a3:	75 c3                	jne    68 <main+0x68>
  }
  exit();
  a5:	e8 98 02 00 00       	call   342 <exit>
  aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1,"enter number");
  b0:	83 ec 08             	sub    $0x8,%esp
  b3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  b6:	68 f2 07 00 00       	push   $0x7f2
  bb:	6a 01                	push   $0x1
  bd:	e8 ce 03 00 00       	call   490 <printf>
  c2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  c5:	83 c4 10             	add    $0x10,%esp
  c8:	8b 7a 04             	mov    0x4(%edx),%edi
  cb:	e9 5c ff ff ff       	jmp    2c <main+0x2c>
    printf(1, "%s Called", argv[0]);
  d0:	50                   	push   %eax
  d1:	ff 32                	pushl  (%edx)
  d3:	68 e8 07 00 00       	push   $0x7e8
  d8:	6a 01                	push   $0x1
  da:	e8 b1 03 00 00       	call   490 <printf>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 05 08 00 00       	mov    $0x805,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 bc 0a 00 00       	mov    %eax,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 7b7:	0a 00 00 
 7ba:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 c0 0a 00 00       	mov    $0xac0,%eax
 7c9:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 7d0:	00 00 00 
