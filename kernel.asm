...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 b5 75 10 80 	movl   $0x801075b5,(%esp)
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 21 57 10 80 	movl   $0x80105721,0x14(%eax)
  p->context = (struct context*)sp;
...
801037ad:	68 38 76 10 80       	push   $0x80107638
...
80103f97:	fb                   	sti    
  ...
  sti();
  acquire(&ptable.lock);
80103f98:	68 20 2d 11 80       	push   $0x80112d20
  cprintf("name \t pid \t state \t \n");
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103f9d:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80103fa2:	e8 69 04 00 00       	call   80104410 <acquire>
  cprintf("name \t pid \t state \t \n");
80103fa7:	c7 04 24 a0 75 10 80 	movl   $0x801075a0,(%esp)
80103fae:	e8 ad c6 ff ff       	call   80100660 <cprintf>
80103fb3:	83 c4 10             	add    $0x10,%esp
80103fb6:	eb 1d                	jmp    80103fd5 <cps+0x45>
80103fb8:	90                   	nop
80103fb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if ( p->state == SLEEPING )
	cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
      else if ( p->state == RUNNING )
80103fc0:	83 f8 04             	cmp    $0x4,%eax
80103fc3:	74 5b                	je     80104020 <cps+0x90>
	cprintf("%s \t %d \t RUNNING \t \n ", p->name, p->pid);
      else if ( p->state == RUNNABLE )
80103fc5:	83 f8 03             	cmp    $0x3,%eax
80103fc8:	74 76                	je     80104040 <cps+0xb0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103fca:	83 c3 7c             	add    $0x7c,%ebx
80103fcd:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103fd3:	73 2a                	jae    80103fff <cps+0x6f>
      if ( p->state == SLEEPING )
80103fd5:	8b 43 0c             	mov    0xc(%ebx),%eax
80103fd8:	83 f8 02             	cmp    $0x2,%eax
80103fdb:	75 e3                	jne    80103fc0 <cps+0x30>
	cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
80103fdd:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103fe0:	83 ec 04             	sub    $0x4,%esp
80103fe3:	ff 73 10             	pushl  0x10(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103fe6:	83 c3 7c             	add    $0x7c,%ebx
	cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
80103fe9:	50                   	push   %eax
80103fea:	68 b7 75 10 80       	push   $0x801075b7
80103fef:	e8 6c c6 ff ff       	call   80100660 <cprintf>
80103ff4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103ff7:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103ffd:	72 d6                	jb     80103fd5 <cps+0x45>
...
80104007:	e8 c4 04 00 00       	call   801044d0 <release>

  return 22;
}
8010400c:	b8 16 00 00 00       	mov    $0x16,%eax
...
80104019:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	cprintf("%s \t %d \t RUNNING \t \n ", p->name, p->pid);
80104020:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104023:	83 ec 04             	sub    $0x4,%esp
80104026:	ff 73 10             	pushl  0x10(%ebx)
80104029:	50                   	push   %eax
8010402a:	68 cf 75 10 80       	push   $0x801075cf
8010402f:	e8 2c c6 ff ff       	call   80100660 <cprintf>
80104034:	83 c4 10             	add    $0x10,%esp
80104037:	eb 91                	jmp    80103fca <cps+0x3a>
80104039:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	cprintf("%s \t %d \t RUNNABLE \t \n ", p->name, p->pid);
80104040:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104043:	83 ec 04             	sub    $0x4,%esp
80104046:	ff 73 10             	pushl  0x10(%ebx)
80104049:	50                   	push   %eax
8010404a:	68 e6 75 10 80       	push   $0x801075e6
8010404f:	e8 0c c6 ff ff       	call   80100660 <cprintf>
80104054:	83 c4 10             	add    $0x10,%esp
80104057:	e9 6e ff ff ff       	jmp    80103fca <cps+0x3a>
...
801040fb:	68 b5 75 10 80       	push   $0x801075b5
...
8010411e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104121:	ba fe 75 10 80       	mov    $0x801075fe,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104126:	77 11                	ja     80104139 <procdump+0x59>
80104128:	8b 14 85 60 76 10 80 	mov    -0x7fef89a0(,%eax,4),%edx
      state = "???";
8010412f:	b8 fe 75 10 80       	mov    $0x801075fe,%eax
...
80104141:	68 02 76 10 80       	push   $0x80107602
...
801041aa:	68 78 76 10 80       	push   $0x80107678
...
801043c5:	68 83 76 10 80       	push   $0x80107683
801043ca:	e8 c1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	68 9a 76 10 80       	push   $0x8010769a
...
801044b7:	68 a1 76 10 80       	push   $0x801076a1
...
8010450c:	68 a9 76 10 80       	push   $0x801076a9
...
80104950:	68 b1 76 10 80       	push   $0x801076b1
...
80104ad5:	68 4b 77 10 80       	push   $0x8010774b
...
80104aea:	68 5a 77 10 80       	push   $0x8010775a
80104aef:	e8 9c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104af4:	83 ec 0c             	sub    $0xc,%esp
80104af7:	68 3c 77 10 80       	push   $0x8010773c
...
80104ee9:	58                   	pop    %eax
80104eea:	5a                   	pop    %edx
80104eeb:	68 58 77 10 80       	push   $0x80107758
...
80104f04:	68 57 77 10 80       	push   $0x80107757
...
80105703:	5d                   	pop    %ebp
  return cps ();
80105704:	e9 87 e8 ff ff       	jmp    80103f90 <cps>
...
8010577e:	00 00 ef 
  initlock(&tickslock, "time");
80105781:	68 9d 77 10 80       	push   $0x8010779d
...
80105800:	ff 24 85 44 78 10 80 	jmp    *-0x7fef87bc(,%eax,4)
...
80105865:	68 00 78 10 80       	push   $0x80107800
...
801059a7:	68 a8 77 10 80       	push   $0x801077a8
...
80105a45:	68 cc 77 10 80       	push   $0x801077cc
80105a4a:	e8 11 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a4f:	83 c4 14             	add    $0x14,%esp
80105a52:	68 a2 77 10 80       	push   $0x801077a2
...
80105b4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b4f:	bb c4 78 10 80       	mov    $0x801078c4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010675d:	68 cc 78 10 80       	push   $0x801078cc
...
80106a39:	68 11 79 10 80       	push   $0x80107911
...
80106b9d:	68 49 79 10 80       	push   $0x80107949
...
80106bd3:	68 61 79 10 80       	push   $0x80107961
...
80106cdc:	68 7d 79 10 80       	push   $0x8010797d
...
80106daf:	68 8e 79 10 80       	push   $0x8010798e
...
80106e99:	68 b2 79 10 80       	push   $0x801079b2
80106e9e:	e8 ed 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ea3:	83 ec 0c             	sub    $0xc,%esp
80106ea6:	68 98 79 10 80       	push   $0x80107998
