  ...
  14:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  4e:	e8 ff 02 00 00       	call   352 <open>
  53:	83 c4 10             	add    $0x10,%esp
  56:	85 c0                	test   %eax,%eax
  58:	89 c6                	mov    %eax,%esi
  5a:	79 16                	jns    72 <main+0x72>
  5c:	eb 44                	jmp    a2 <main+0xa2>
  5e:	66 90                	xchg   %ax,%ax
     printf(1, "wc: cannot open %s\n", argv[1]);
     exit();
  }
  ...
  63:	50                   	push   %eax
  64:	68 c0 0a 00 00       	push   $0xac0
  69:	56                   	push   %esi
  6a:	e8 c3 02 00 00       	call   332 <write>
  ...
  7f:	53                   	push   %ebx
  80:	e8 a5 02 00 00       	call   32a <read>
  ...
  8f:	53                   	push   %ebx
  90:	e8 a5 02 00 00       	call   33a <close>
  close(fd1);
  95:	89 34 24             	mov    %esi,(%esp)
  98:	e8 9d 02 00 00       	call   33a <close>
  exit();
  9d:	e8 70 02 00 00       	call   312 <exit>
     printf(1, "wc: cannot open %s\n", argv[1]);
  a2:	50                   	push   %eax
  a3:	ff 77 04             	pushl  0x4(%edi)
  a6:	68 c8 07 00 00       	push   $0x7c8
  ab:	6a 01                	push   $0x1
  ad:	e8 ae 03 00 00       	call   460 <printf>
     exit();
  b2:	e8 5b 02 00 00       	call   312 <exit>
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
