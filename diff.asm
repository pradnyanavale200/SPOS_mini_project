  ...
  14:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  25:	e8 86 04 00 00       	call   4b0 <printf>
    exit();
  2a:	e8 33 03 00 00       	call   362 <exit>
  }
  ...
  36:	e8 67 03 00 00       	call   3a2 <open>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	85 c0                	test   %eax,%eax
  40:	89 c6                	mov    %eax,%esi
  42:	0f 88 81 00 00 00    	js     c9 <main+0xc9>
  ...
  4f:	e8 4e 03 00 00       	call   3a2 <open>
  54:	83 c4 10             	add    $0x10,%esp
  57:	85 c0                	test   %eax,%eax
  59:	89 c7                	mov    %eax,%edi
  5b:	0f 88 89 00 00 00    	js     ea <main+0xea>
     printf(1, "cannot open %s\n", argv[2]);
     exit();
  }
  ...
  67:	68 40 0b 00 00       	push   $0xb40
  6c:	56                   	push   %esi
  6d:	e8 08 03 00 00       	call   37a <read>
  72:	83 c4 10             	add    $0x10,%esp
  75:	85 c0                	test   %eax,%eax
  77:	0f 8e 82 00 00 00    	jle    ff <main+0xff>
    if((n2 = read(fd1,buf2, sizeof(buf2))) > 0) {
  7d:	53                   	push   %ebx
  7e:	68 00 02 00 00       	push   $0x200
  83:	68 40 0d 00 00       	push   $0xd40
  88:	57                   	push   %edi
  89:	e8 ec 02 00 00       	call   37a <read>
  8e:	83 c4 10             	add    $0x10,%esp
  91:	85 c0                	test   %eax,%eax
  93:	7e cc                	jle    61 <main+0x61>
      if(n1 >0 && n2>0){
      	for(i = 0; i < n2; i++){
  95:	31 d2                	xor    %edx,%edx
          if(buf1[i] != buf2[i]){
  97:	0f b6 9a 40 0d 00 00 	movzbl 0xd40(%edx),%ebx
  9e:	38 9a 40 0b 00 00    	cmp    %bl,0xb40(%edx)
  a4:	74 38                	je     de <main+0xde>
            printf(1, "Files are different");
  a6:	51                   	push   %ecx
  a7:	51                   	push   %ecx
  a8:	68 28 08 00 00       	push   $0x828
       close(fd1);
       exit();
      }
    }
  ...
  close(fd0);
  b4:	89 34 24             	mov    %esi,(%esp)
  b7:	e8 ce 02 00 00       	call   38a <close>
  close(fd1);
  bc:	89 3c 24             	mov    %edi,(%esp)
  bf:	e8 c6 02 00 00       	call   38a <close>
  exit();
  c4:	e8 99 02 00 00       	call   362 <exit>
     printf(1, "cannot open %s\n", argv[1]);
  c9:	50                   	push   %eax
  ca:	ff 73 04             	pushl  0x4(%ebx)
  ...
  e1:	39 d0                	cmp    %edx,%eax
  e3:	75 b2                	jne    97 <main+0x97>
  e5:	e9 77 ff ff ff       	jmp    61 <main+0x61>
     printf(1, "cannot open %s\n", argv[2]);
  ea:	56                   	push   %esi
  eb:	ff 73 08             	pushl  0x8(%ebx)
  ee:	68 18 08 00 00       	push   $0x818
  f3:	6a 01                	push   $0x1
  f5:	e8 b6 03 00 00       	call   4b0 <printf>
     exit();
  fa:	e8 63 02 00 00       	call   362 <exit>
  printf(1, "Files are same");
  ff:	50                   	push   %eax
 100:	50                   	push   %eax
 101:	68 3c 08 00 00       	push   $0x83c
 106:	eb a5                	jmp    ad <main+0xad>
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 4b 08 00 00       	mov    $0x84b,%ebx
        while(*s != 0){
